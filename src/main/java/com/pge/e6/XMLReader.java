...
import com.pge.e6.FileReader;
import com.pge.e6.IntervalReading;
import com.pge.e6.Tester;

import java.io.*;
public class XMLReader
{
	public static double[] findPeakPartNonUsage(String filename, int startMonth, int startDay, int startYear, int endMonth, int endDay, int endYear)
	{
		return findPeakPartNonUsage(filename, startMonth, startDay, startYear, endMonth, endDay, endYear, 0, 0, 0, 0);
	}
	public static double[] findPeakPartNonUsage(String filename, int startMonth, int startDay, int startYear, int endMonth, int endDay, int endYear, double chargingLevel, double weekdayDistance, double weekendDistance, int chargeStartTime) 
	{
		...
		try
		{
			...
			for (IntervalReading ir: iRList)
			{
				...
				boolean isSummer = findIsSummer(date);
				...
				else//winter
				{
					...
					{
						if(dayHoursWinterDST[dayOfWeek][hour].equalsIgnoreCase("part"))
						{
					...
					{
						if(dayHoursWinter[dayOfWeek][hour].equalsIgnoreCase("part"))
						{
							winterPartPeak += ir.getValue();
						}
						else//Off
			...
			returnArray = new double[]{convertedSummerPeak, convertedSummerPartPeak, convertedSummerNonPeak, convertedWinterPartPeak, convertedWinterNonPeak};
			return returnArray;			
